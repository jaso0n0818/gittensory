...
describe("private-beta auth and rate limiting", () => {
  ...
  it("classifies rate-limit route costs", () => {
    ...
    expect(routeClassForPath("/v1/internal/jobs/file-upstream-drift-issues")).toBe("expensive");
    expect(routeClassForPath("/v1/internal/jobs/file-upstream-drift-issues/run")).toBe("expensive");
